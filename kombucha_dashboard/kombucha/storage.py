...
CREATE TABLE IF NOT EXISTS readings (
    ...
    pH REAL, conductivity REAL, turbidity REAL, color REAL,
    temperature_C REAL, water_level_pct REAL, pressure_bar REAL
);
"""
...
COLUMNS = [
    ...
    "temperature_C", "water_level_pct", "pressure_bar",
]
